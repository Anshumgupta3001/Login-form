...
//         try {
//             const [rows] = await connection.query('CALL storedprocedure()');
//             console.log(rows);
...
app.post('/save', async (req, res) => {
    ...
    try {
        await connection.query('INSERT INTO details (firstName, lastName, email, country, city, gender, dob, age) VALUES (?, ?, ?, ?, ?, ?, ?, ?)', [firstName, lastName, email, country, city, gender, dob, age]);
        connection.release();
